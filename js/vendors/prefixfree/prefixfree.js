    ...
    link: function(link) {
      ...
      process = function() {
        ...
        if (
          ...
          if (css && base) {
            css = css.replace(/url\(\s*?((?:"|')?)(.+?)\1\s*?\)/gi, function(
              $0,
              quote,
              url
            ) {
...
(function(root) {
  ...
  var self = (window.PrefixFree = {
    ...
    property: function(property) {
      return (
        (self.properties.indexOf(property) >= 0 ? self.prefix : "") + property
      );
    },
  ...
  self.valueProperties = ["transition", "transition-property", "will-change"];
